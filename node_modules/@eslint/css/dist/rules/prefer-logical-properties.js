    ...
    create(context) {
        ...
        return {
            Declaration(node) {
                ...
                const propertyReplacement = propertiesReplacements.get(property);
                ...
                const valueReplacements = propertyValuesReplacements.get(property);
                if (valueReplacements &&
                    ...
                    const valueReplacement = valueReplacements[nodeValue.toLowerCase()];
                    if (valueReplacement) {
                        context.report({
                            loc: identifier.loc,

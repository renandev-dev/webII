        ...
        return {
            Declaration(node) {
                if (node.important) {
                    ...
                    const valueEndOffset = node.value.loc.end.offset - nodeStartOffset;
                    const importantMatch = importantPattern.exec(textWithoutComments.slice(valueEndOffset));
                    const importantStartOffset = valueEndOffset + importantMatch.index;

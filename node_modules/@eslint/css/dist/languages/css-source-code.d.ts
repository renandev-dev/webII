...
import type { CssNode, CssNodePlain, CssLocationRange, Comment, Lexer, StyleSheetPlain } from "@eslint/css-tree";
import type { SourceRange, FileProblem, RulesConfig } from "@eslint/core";
 ...
 */
export declare class CSSSourceCode extends TextSourceCodeBase<{
     ...
     * @override
     */
    getRange(node: CssNodePlain): SourceRange;
    /**
